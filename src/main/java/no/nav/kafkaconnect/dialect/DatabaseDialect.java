...
import no.nav.kafkaconnect.sink.ColumnMapping;
import no.nav.kafkaconnect.sink.JdbcSinkConfig;
import no.nav.kafkaconnect.sink.TimestampIncrementingCriteria;
 ...
 * file a {@code META-INF/services/no.nav.kafkaconnect.dialect.DatabaseDialectProvider} file
