...
import no.nav.kafkaconnect.dialect.DatabaseDialectProvider.SubprotocolBasedProvider;
import no.nav.kafkaconnect.sink.metadata.SinkRecordField;
import no.nav.kafkaconnect.util.ColumnId;
import no.nav.kafkaconnect.util.ExpressionBuilder;
import no.nav.kafkaconnect.util.ExpressionBuilder.Transform;
import no.nav.kafkaconnect.util.IdentifierRules;
import no.nav.kafkaconnect.util.TableId;
