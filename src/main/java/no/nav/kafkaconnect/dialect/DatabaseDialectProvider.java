 ...
 * {@code META-INF/services/no.nav.kafkaconnect.dialect.DatabaseDialectProvider}.
 *
 * <p>For example, all of the dialects providers provided by the Confluent JDBC connector are listed
 * in the {@code META-INF/services/no.nav.kafkaconnect.dialect.DatabaseDialectProvider}.
