...
public class JdbcSourceConnectorConfig extends AbstractConfig {
  ...
  public static final String QUOTE_SQL_IDENTIFIERS_DISPLAY = "Da";
  ...
  public enum NumericMapping {
    ...
    public static NumericMapping get(JdbcSourceConnectorConfig config) {
      ...
      if (config.getBoolean(JdbcSinkConfig.NUMERIC_PRECISION_MAPPING_CONFIG)) {
  ...
  public TimeZone timeZone() {
    String dbTimeZone = getString(JdbcSinkConfig.DB_TIMEZONE_CONFIG);
